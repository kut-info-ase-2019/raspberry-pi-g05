...
def main():
	...
	while True:
		...
		for i in range(10):
			...
			if get_distance() < NOMAN_DISTANCE:
		...
		amp_percent = int(amp_count/fn*100)
		print(amp_percent, "%")

		print("result of counting human :",human_count)
		print('humidity: %s %%,  Temperature: %s C' % (humidity, temperature))
		...
		c.execute(sql, (1, timekey, temperature, humidity, human_count, amp_percent)) # 追加を行うSQL文の実行
